...
if os.getenv("GH_OWNER") == None:
    print("GH_OWNER ", os.getenv("GH_OWNER"))
    ENV_ERROR = True
    
if os.getenv("DW_OWNER") == None:
    print("DW_OWNER", os.getenv("DW_OWNER"))
    ENV_ERROR = True

if os.getenv("DW_AUTH_TOKEN") == None:
...
def main():
    assert GH_OWNER != None, ", Add GH_USER=<your-github-user-name> in a data.world/scripts/adopt-a-world/.env file?"
    assert DW_OWNER != None, ", Add DW_USER=<your-github-user-name> in a data.world/scripts/adopt-a-world/.env file?"
